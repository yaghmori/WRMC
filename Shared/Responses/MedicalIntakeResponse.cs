...
{
    public class MedicalIntakeResponse
    {
        ...
        public List<SymptomsEnum> Symptoms { get; set; } = new();
        ...
        public List<DrugFrequencyResponse> DrugFrequency { get; set; } = new();
        ...
        public List<STDTypesEnum> StdTypes { get; set; }  =new ();
